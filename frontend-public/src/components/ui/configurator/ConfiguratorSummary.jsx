export default function ConfiguratorSummary({
  ...
  return (
    <div
      ...
      style={{ background: "#0a0f0d", border: "0.5px solid #1a2e24" }}
    >
      <p
      ...
      {!selectedPackage ? (
        <p className="text-sm" style={{ color: "#4d7060" }}>
        ...
        <>
          ...
          <div
            className="mb-3 pb-3"
            style={{ borderBottom: "0.5px solid #1a2e24" }}
          >
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium" style={{ color: "#e2ede8" }}>
              ...
              {allServices
                ...
                .map((s) => (
                  <div key={s.id} className="flex justify-between items-center">
                    <p className="text-xs" style={{ color: "#6b8f7d" }}>
                      {s.name}
                    </p>
                    <p className="text-xs" style={{ color: "#2dd4a0" }}>
                      incluso
            ...
            >
              {selectedServices.map((s) => (
                <div key={s.id} className="flex justify-between items-start">
                  <p
                    className="text-xs"
                    style={{ color: "#6b8f7d", maxWidth: "60%" }}
                  >
                    {s.name}
                  </p>
                  <div className="text-right">
